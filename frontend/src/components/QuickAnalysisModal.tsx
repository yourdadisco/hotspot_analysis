...
const PROVIDER_CONFIGS: Record<string, { base: string; models: string[] }> = {
  'OpenAI': { base: 'https://api.openai.com/v1', models: ['gpt-4o', 'gpt-4o-mini', 'o3', 'o4-mini'] },
  ...
  'Kimi': { base: 'https://api.moonshot.cn/v1', models: ['moonshot-v1-32k', 'moonshot-v1-128k'] },
  'MiniMax': { base: 'https://api.minimax.chat/v1', models: ['MiniMax-Text-01', 'abab6.5s', 'abab5.5s'] },
  'Mimo': { base: 'https://api.mimo.com/v1', models: ['mimo-chat', 'mimo-chat-mini'] },
  '豆包': { base: 'https://ark.cn-beijing.volces.com/api/v3', models: ['doubao-pro-32k', 'doubao-pro-128k'] },
}
